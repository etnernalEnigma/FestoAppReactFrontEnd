	...
	public render(): JSX.Element {
		...
		return (
			...
			<div className="card" id="card">
  				<img src={this.props.course.images? this.props.course.images.overview? 
				  this.props.course.images.overview	:	this.props.course.images.thumbnail: 
				  ...
				  className="card-img-top image-height" alt="no-image"/>
  				<div className="card-body">
			    <h5 className="card-title">{this.props.course? this.props.course.name : "card title"}</h5>
			    <p className="card-text" >by {this.props.user}</p>
